  ...
  const App = {
    ...
    handlers: {
      pokemonFinderFormOnSubmit: async (e) => {
        ...
        const checkboxEvoChain =
          App.htmlElements.checkboxEvolucionesPoke.checked;
        query.toUpperCase();
        //query.toUpperCase();
        console.log(query);
        try {
          ...
          if (data.responseData) {
            data.responseData["checkboxSprites"] = checkboxSprites;

            data.responseData["checkboxUbicacion"] = checkboxLocation;

            data.responseData["checkboxEvoluciones"] = checkboxEvoChain;
    ...
    templates: {
      ...
      pokemonCard: ({
        ...
        const listaUbicacion = locations_areas.map(
